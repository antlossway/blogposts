---
title: "Amplify authentication: How to Sync DynamoDB user with Cognito account"
date: "2023-09-08"
description: "Amplify authentication provides a simple authentication solution for app, but how to sync the under-the-hood Cognito account with the User datamodel of the App is not so simple, this article provide a solution using pre-SignUp lambda function to create user upon signUp."
tags: ["AWS Amplify", "React Native", "Expo"]
---
...
![Amplify UI Authentication Form](/img/amplify-ui-auth-form.png)
...
![Cognito user](/img/amplify-studio-cognito-user.png)

And the user created in Dynamo DB "User" table:
![Dynamo DB user](/img/amplify-studio-user-table.png)
